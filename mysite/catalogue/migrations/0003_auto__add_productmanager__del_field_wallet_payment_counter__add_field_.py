...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'catalogue_productmanager', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'catalogue', ['ProductManager'])

        # Deleting field 'Wallet.payment_counter'
        db.delete_column(u'catalogue_wallet', 'payment_counter')

        # Adding field 'Wallet.transaction_counter'
        db.add_column(u'catalogue_wallet', 'transaction_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Wallet.label'
        db.add_column(u'catalogue_wallet', 'label',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'catalogue_productmanager')

        # Adding field 'Wallet.payment_counter'
        db.add_column(u'catalogue_wallet', 'payment_counter',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'Wallet.transaction_counter'
        db.delete_column(u'catalogue_wallet', 'transaction_counter')

        # Deleting field 'Wallet.label'
        db.delete_column(u'catalogue_wallet', 'label')
    ...
    models = {
        ...
        u'catalogue.productmanager': {
            'Meta': {'object_name': 'ProductManager'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'catalogue.wallet': {
            ...
            'transaction_counter': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'transactions_with': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['catalogue.Wallet']", 'through': u"orm['catalogue.WalletTransaction']", 'symmetrical': 'False'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wallet'", 'to': u"orm['auth.User']"})
        },
        u'catalogue.walletstore': {
            'Meta': {'object_name': 'WalletStore'},
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'store'", 'to': u"orm['catalogue.Product']"}),
            'received_amount': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'wallet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'store'", 'to': u"orm['catalogue.Wallet']"})
        },
