...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'catalogue_wallet', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=-1, related_name='wallet', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Wallet.user'
        db.delete_column(u'catalogue_wallet', 'user_id')
