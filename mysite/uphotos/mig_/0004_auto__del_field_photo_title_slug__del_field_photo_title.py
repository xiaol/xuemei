...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'uPhotos_photo', 'title_slug')

        # Deleting field 'Photo.title'
        db.delete_column(u'uPhotos_photo', 'title')


    def backwards(self, orm):
        # Adding field 'Photo.title_slug'
        db.add_column(u'uPhotos_photo', 'title_slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50, unique=True),
                      keep_default=False)

        # Adding field 'Photo.title'
        db.add_column(u'uPhotos_photo', 'title',
