...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Photo'
        db.create_table(u'uphotos_photo', (
            ...
            ('tags', self.gf('uphotos.models.TagField')(max_length=255, blank=True)),
            ...
            ('is_confirm', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'uphotos', ['Photo'])

        # Adding model 'Gallery'
        db.create_table(u'uphotos_gallery', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ...
        db.send_create_signal(u'uphotos', ['Gallery'])

        # Adding M2M table for field photos on 'Gallery'
        db.create_table(u'uphotos_gallery_photos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gallery', models.ForeignKey(orm[u'uphotos.gallery'], null=False)),
            ('photo', models.ForeignKey(orm[u'uphotos.photo'], null=False))
        ))
        db.create_unique(u'uphotos_gallery_photos', ['gallery_id', 'photo_id'])


    def backwards(self, orm):
        # Deleting model 'Photo'
        db.delete_table(u'uphotos_photo')

        # Deleting model 'Gallery'
        db.delete_table(u'uphotos_gallery')

        # Removing M2M table for field photos on 'Gallery'
        db.delete_table('uphotos_gallery_photos')
    ...
    models = {
        ...
        u'uphotos.gallery': {
            ...
            'photos': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'galleries'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['uphotos.Photo']"}),
            'tags': ('uphotos.models.TagField', [], {'max_length': '255', 'blank': 'True'}),
        ...
        u'uphotos.photo': {
            ...
            'is_confirm': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
