...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'profiles_profile', 'birth_date')

        # Adding field 'Profile.identification'
        db.add_column(u'profiles_profile', 'identification',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'profiles_profile', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)

        # Deleting field 'Profile.identification'
        db.delete_column(u'profiles_profile', 'identification')
    ...
    models = {
        ...
        u'profiles.address': {
            ...
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'address'", 'to': u"orm['profiles.Profile']"}),
        ...
        u'profiles.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identification': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
