...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_address', (
            ...
            ('location', self.gf('django.contrib.gis.db.models.fields.PointField')(srid=32140, null=True)),
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'profiles_profile', 'location',
                      self.gf('django.contrib.gis.db.models.fields.PointField')(srid=32140, null=True),
                      keep_default=False)
