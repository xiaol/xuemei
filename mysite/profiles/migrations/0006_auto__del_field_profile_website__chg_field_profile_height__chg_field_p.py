...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_profile', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Profile.income'
        db.alter_column(u'profiles_profile', 'income', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Profile.birth_date'
        db.alter_column(u'profiles_profile', 'birth_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 21, 0, 0)))
        # Deleting field 'Address.profile'
        db.delete_column(u'profiles_address', 'profile_id')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.height'
        db.alter_column(u'profiles_profile', 'height', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Profile.income'
        db.alter_column(u'profiles_profile', 'income', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Profile.birth_date'
        db.alter_column(u'profiles_profile', 'birth_date', self.gf('django.db.models.fields.DateField')(null=True))
        # Adding field 'Address.profile'
        db.add_column(u'profiles_address', 'profile',
    ...
    models = {
        ...
        u'profiles.profile': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'income': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'language': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '5'}),
            'marital_status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'message_price': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
